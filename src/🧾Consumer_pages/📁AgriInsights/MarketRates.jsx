...
const styles = {
  ...
  cardIconBox: { 
    ...
    borderRadius: '12px', 
    background: 'rgba(255, 255, 255, 0.05)',
    transform: 'translateZ(0)', willChange: 'transform, backdrop-filter', backdropFilter: 'blur(20px)', 
    display: 'flex', 
    alignItems: 'center', 
    justifyContent: 'center', 
    flexShrink: 0,
  ...
  infoModalContent: { 
    ...
    transform: 'translateZ(0)', willChange: 'transform, backdrop-filter', backdropFilter: 'blur(40px) saturate(150%)', 
  ...
  modalOverlay: { 
    ...
    transform: 'translateZ(0)', willChange: 'transform, backdrop-filter', backdropFilter: 'blur(8px)', 
    zIndex: 1000, 
    display: 'flex', 
    alignItems: 'center', 
    justifyContent: 'center', 
  ...
  modalContent: { 
    ...
    boxSizing: 'border-box',
    transform: 'translateZ(0)', willChange: 'transform, backdrop-filter', backdropFilter: 'blur(30px) saturate(150%)',
  ...
  fullPageOverlay: { 
    ...
    transform: 'translateZ(0)', willChange: 'transform, backdrop-filter', backdropFilter: 'blur(16px) saturate(150%)', 
