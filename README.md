...
flowchart TD
    ...
    subgraph ConsumerSpace["🛒 Consumer / Buyer Mode"]
        ...
        Cart["🛍️ Smart Cart & Multi-Item Checkout"]:::buyer
    end
    ...
    subgraph AIAndTools["⚡ Agritech Intelligence Suite"]
        ...
        GPSMeasure["🗺️ GPS Acreage & Perimeter Land Surveyor"]:::ai
...
│   │   ├── GPSMeasurement.jsx  # 🗺️ GPS Land & Acreage Surveyor
...
│   ├── App.jsx                 # ⚛️ Root application component & routes
