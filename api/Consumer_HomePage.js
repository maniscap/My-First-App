// Consumer_HomePage.jsx API Handler
// Fetches weather data for Consumer_HomePage.jsx page
// Route: POST /api/Consumer_HomePage
...
export default async function handler(req, res) {
  ...
  try {
    ...
    console.error('Consumer_HomePage API Error:', error);
    res.status(500).json({ error: 'Failed to fetch Consumer_HomePage weather data', details: error.message });
  }
}
